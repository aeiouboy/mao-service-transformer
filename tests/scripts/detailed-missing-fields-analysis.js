...
class DetailedMissingFieldsAnalysis {
  constructor() {
    this.resultPath = '/Users/chongraktanaka/Projects/mao-service-transformer/release/test-output.json';
    this.samplePath = '/Users/chongraktanaka/Projects/mao-service-transformer/data/samples/sample_order.json';
    this.missingFields = [];
  ...
  saveDetailedReport(report) {
    const reportPath = '/Users/chongraktanaka/Projects/mao-service-transformer/tests/scripts/detailed-missing-fields-report.txt';
    fs.writeFileSync(reportPath, report);
    console.log(`📄 Detailed report saved to: ${reportPath}`);
    
    // Also save JSON version
    const jsonReportPath = '/Users/chongraktanaka/Projects/mao-service-transformer/tests/scripts/missing-fields.json';
